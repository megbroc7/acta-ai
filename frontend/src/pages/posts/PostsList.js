...
const PostsList = () => {
  ...
  return (
    <Box>
      <PageHeader
        title="Blog Posts"
        description="View and manage your AI-generated WordPress blog posts"
      />
      ...
      {posts.length === 0 ? (
        <EmptyState
          title="No Blog Posts"
          description="This blog section is empty. AI-generated posts based on your scheduled content or templates will appear here once created."
